...
export type Reader =  {readerID: number, name: string, weeklyReadingGoal: number, totalMinutesRead: number};
...
export type Book = {bookID: number, title: string, author: string, publicationYear: number};
...
export const allBooks = [
    ...
    {bookID: 6, title: 'Alice in Wonderland', author: 'Lewis Carroll', publicationYear: 1865}
];
